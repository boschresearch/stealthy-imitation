...
obs_shape = 17
act_shape = 6
exp_name='exp/halfcheetah/gail_estimate_seed4'
main_config = EasyDict(
    dict(
        ...
        reward_model=dict(
            ...
            expert_model_path='exp/halfcheetah/sac_seed0/ckpt/ckpt_best.pth.tar', 
            # Path where to store the reward model
            reward_model_path=f'{exp_name}/reward_model/ckpt/ckpt_best.pth.tar',
